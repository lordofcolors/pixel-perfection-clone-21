                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="background-color: #030817; border: none; border-radius: 0 0 16px 16px; padding: 28px 24px;">
                  <tr>
                    <td style="padding: 28px 24px;">
                      ...
                      <p style="margin: 0 0 8px; font-size: 14px; font-weight: normal; color: #94DFE9; font-family: Arial, Helvetica, sans-serif;">
                        Hi Donald,
                      </p>
                      <p style="margin: 0 0 24px; font-size: 14px; color: #94DFE9; line-height: 1.6; font-family: Arial, Helvetica, sans-serif;">
