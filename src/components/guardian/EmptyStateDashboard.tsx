...
import { BookOpen, Users, TrendingUp, Clock, ArrowRight, Target, Plus } from "lucide-react";
...
export function EmptyStateDashboard({ guardianName, learners, onSelectView }: EmptyStateDashboardProps) {
  ...
  const handleAssignClick = (learnerName: string) => {
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-2xl">Welcome to Your Parent Dashboard! 🎉</CardTitle>
                <CardDescription className="text-base">
                  You're all set up! Here's what you can do next to support your learner's journey.
                </CardDescription>
              </div>
              <Button onClick={() => learners.length > 0 && handleAssignClick(learners[0].name)} size="lg">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Button className="w-full" onClick={(e) => {
                          e.stopPropagation();
                          handleAssignClick(learner.name);
                        }}>
