        ...
        <div className="space-y-2">
          ...
          <ol className="grid gap-1.5">
            {lessons.map((lesson, idx) => (
              <li
                key={idx}
                className="flex items-center gap-3 rounded-lg border border-border bg-muted/30 px-3 py-1.5"
              >
                ...
                <input
                  ...
                  className="flex-1 bg-transparent text-sm text-foreground outline-none focus:underline focus:decoration-primary/40 focus:underline-offset-2"
                />
              </li>
            ))}
          </ol>
