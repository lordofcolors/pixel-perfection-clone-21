...
export function ChatTranscriptPanel({ firstName, onClose, messages, onSendMessage, inputValue, onInputChange }: ChatTranscriptPanelProps) {
    ...
    <div className="flex flex-col h-full bg-card/30 border-l border-border/50">
      ...
      <div className="p-3 border-t border-border/50">
        <div className="flex items-center gap-2 rounded-xl border border-border/50 p-1.5">
          ...
          />
          <Button size="icon" className="flex-shrink-0 h-8 w-8 bg-primary hover:bg-primary/90" onClick={handleSend}>
