 ...
 * =============================================================================
 *
 * Gmail-inspired inbox preview with toggle between Dark and Light mode
 * HTML email templates for the Weekly Digest.
 */
  ...
  return (
    <div className="flex h-screen w-screen flex-col bg-[#f6f8fc]">
      ...
      <div className="flex items-center gap-2 border-b border-gray-200 bg-white px-4 py-2">
        ...
        {/* Mode toggle */}
        <div className="ml-4 flex items-center gap-1 rounded-full border border-gray-200 bg-gray-50 p-0.5">
          <button
